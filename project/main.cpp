...
// returns the index of the entry in the table that matches WANprt, -1 otherwise 
...
// returns the index of the entry in the table that matches (LANaddr, LANprt), -1 otherwise
